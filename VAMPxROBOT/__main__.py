...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/ebf62ff4c5668adcfa28c.jpg), ɪᴍ 𝐕𝐀𝐌𝐏 𝐗 ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [𝐕𝐀𝐌𝐏 𝐗🙋‍♀️](https://telegra.ph/file/f1d9df9d183b7d78670dd.jpg) 
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

vamp_IMG = "https://telegra.ph/file/653fd1b57bcdcdd8c35c5.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @M1CKEY_0P \
...
@run_async
def vamp_about_callback(update, context):
    query = update.callback_query
    if query.data == "vamp_":
        query.message.edit_text(
            text=""" ℹ️ I'm *vamp*, a powerful group management bot built to help you manage your group easily.
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="vamp_back")
                 ]
                ]
            ),
        )
    elif query.data == "vamp_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(vamp_about_callback, pattern=r"vamp_")
